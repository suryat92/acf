...
@description('Management group ID for polcy assignement.')
...
var varPolicyAssignmentIdentityRoleAssignmentsMGsConverged = parPolicyAssignmentIdentityType == 'SystemAssigned' ? union(parPolicyAssignmentIdentityRoleAssignmentsAdditionalMGs, parManagementGroupIDs) : []
