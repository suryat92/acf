  ...
  properties: {
    ...
    subnets: [for subnet in subnets: {
      ...
      properties: {
        ...
        networkSecurityGroup: contains(subnet, 'networkSecurityGroupName') ? (empty(subnet.networkSecurityGroupName) ? null : json('{"id": "${resourceId('Microsoft.Network/networkSecurityGroups', subnet.networkSecurityGroupName)}"}')) : null
      }
    }]
  }
}
...
output outresourceId string = virtualNetwork.id
